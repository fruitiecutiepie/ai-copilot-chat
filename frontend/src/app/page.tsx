...
export default function Home() {
    ...
    (async () => {
      try {
        ...
        const resSchema = z.object({
          chatMessageHumanHuman: z.array(ChatMessageSchema),
          chatMessageHumanAi: z.array(ChatMessageSchema)
        });
        ...
        setMessages(resData.chatMessageHumanHuman);
        setMessagesLlm(resData.chatMessageHumanAi);
      } catch (err) {
  ...
  const sendChatLlm = async () => {
    ...
    try {
      ...
      setMessagesLlm((prev) => [...prev, resParsed.data]);
    } catch (err) {
      console.error("Upload failed", err);
    }
